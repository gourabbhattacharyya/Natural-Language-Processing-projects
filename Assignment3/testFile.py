...
def depParse_weight_init():
    ...
    """
    def _depParse_initializer(shape, **kwargs):
        ...
        out = tf.Variable(tf.random_uniform(shape=shape, minval=-epsilon, maxval=epsilon), trainable=True)
        print("out", out)
        ### END YOUR CODE
        return out
    # Returns defined initializer function.
    return _depParse_initializer
...
def test_initialization_basic():
    ...
    xavier_initializer = depParse_weight_init()
    shape = (1,)
